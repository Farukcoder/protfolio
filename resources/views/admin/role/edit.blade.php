                        ...
                        <form action="{{ route('role.update', $role->id) }}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('role_name') is-invalid @enderror" id="role_name" name="role_name" value="{{ $role->name }}" required placeholder="Role Name">
                                                    ...
                                                    @foreach ($permissions as $permission)
                                                        <div class="custom-control custom-checkbox p-3" style="display:inline-block;">
                                                            <input class="custom-control-input" type="checkbox" name="permissions[]" id="permissions{{ $permission->id }}" value="{{ $permission->id }}"
                                                                   @foreach($role->permissions as $select_permission)
